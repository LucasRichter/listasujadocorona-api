...
module.exports.postTweet = async (politician) => {
  ...
  const status = `
    ${politician.name} (${politician.twitter}) está na lista de políticos que apoiam medidas anti-ciência. ${process.env.API_DOMAIN}/detalhes/${politician.slug} #ListaSujaDoCorona
  `
